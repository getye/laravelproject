					...
					<div class="navbar-nav">
                        	<div class="dropdown">
								...
								<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
									...
									<a class="dropdown-item" href="#">Registration Request</a>
									<a class="dropdown-item" href="#">Course Add Request</a>
									<a class="dropdown-item" href="#">Course Drop Request</a>
								</div>
						   </div>	
                            <a class="nav-item nav-link" href="#">Schedule</a>
                            <a class="nav-item nav-link" href="#">Notice</a>
